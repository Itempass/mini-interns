  ...
  return (
    <div className="flex flex-col flex-1 relative bg-gray-100 min-h-0 overflow-hidden" style={{
      ...
      <div className="flex flex-1 overflow-hidden gap-4 p-4 min-h-0">
        <div className="w-64 flex-shrink-0 flex flex-col bg-white border border-gray-300 rounded-lg overflow-hidden shadow-md h-full min-h-0">
          <LogsSidebar />
        </div>

        <main className="flex-1 bg-white border border-gray-300 rounded-lg shadow-md flex flex-col overflow-hidden min-h-0">
